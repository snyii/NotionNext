...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'E_suni', // 您的昵称 例如 tangly1024
  ...
  CHATBASE_ID: process.env.NEXT_PUBLIC_CHATBASE_ID || 'Gdq97N9WrTF_7tFZiVasi',
  ...
  WIDGET_PET_LINK:
        ...
        'https://imuncle.github.io/live2d/model/mashiro/seifuku.model.json', // 挂件模型地址 @see https://github.com/xiazeyu/live2d-widget-models
  ...
  MUSIC_PLAYER_AUDIO_LIST: [
    // 示例音乐列表。除了以下配置外，还可配置歌词，具体配置项看此文档 https://aplayer.js.org/#/zh-Hans/
    {
      name: '响',
      artist: '里里',
      url: 'http://music.163.com/song/media/outer/url?id=2102062429.mp3',
      cover:
            'https://p1.music.126.net/te9vuDuvWysztn9tSLQC0Q==/109951169071708218.jpg'
    }
  ],
